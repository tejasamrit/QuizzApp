...
//        setUndecorated(true);
        ...
        add(image);
        qno = new JLabel();
        qno.setBounds(150, 320, 50, 30);
        qno.setFont(new Font("Tahoma", Font.PLAIN, 24));
        add(qno);
        question = new JLabel();
        question.setBounds(180, 320, 700, 30);
        ...
        opt1.setBounds(180, 370, 500, 30);
        opt1.setBackground(Color.WHITE);
        opt1.setFont(new Font("Dialog", Font.PLAIN, 20));
        add(opt1);

        opt2 = new JRadioButton();
        opt2.setBounds(180, 410, 500, 30);
        opt2.setBackground(Color.WHITE);
        opt2.setFont(new Font("Dialog", Font.PLAIN, 20));
        add(opt2);

        opt3 = new JRadioButton();
        opt3.setBounds(180, 450, 500, 30);
        opt3.setBackground(Color.WHITE);
        opt3.setFont(new Font("Dialog", Font.PLAIN, 20));
        add(opt3);

        opt4 = new JRadioButton();
        opt4.setBounds(180, 490, 500, 30);
        ...
        lifeline.setBounds(650, 570, 200, 30);
    ...
    public void paint(Graphics g) {
        ...
        String time = "Time left - " + timer + " seconds";
         ...
         if (timer > 0) {
//             150, 320, 50, 30
         g.drawString(time, 760, 380);
         } else {
         g.drawString("Times up!!", 760, 380);
         }        timer--; // 14
         try {
         Thread.sleep(1000);
         repaint();
